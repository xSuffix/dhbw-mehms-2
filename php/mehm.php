        ...
        <aside class="paperlike meta">
            <div class="posted">
                ...
                <div class="posted-text">
                    <p><?php echo '<a class="underline" href="./?filter=' . $mehm["Type"] . '">#' . $mehm["Type"] . '</a>' ?>
                        <br> Gepostet
                        von <?php echo '<a class="underline" href="./?search=u%2F' . $mehm["Name"] . '">u/' . $mehm["Name"] . "</a> " . timeElapsedString($mehm["VisibleOn"]) ?>
                    </p>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <button class="meta-icon icon-text"
                        id="like" <?php echo ($isLogedin) ? '' : ' style="cursor: not-allowed;"' ?>>
                    <?php
            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="share-button" class="icon-md" viewBox="0 0 20 20"
                 fill="currentColor">
