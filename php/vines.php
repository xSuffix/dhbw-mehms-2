    ...
    <div class="paper">
      ...
      <div class="gallery">
        ...
        foreach ($videos as $video) {
          try {
            echo '<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/' . $video . '" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
