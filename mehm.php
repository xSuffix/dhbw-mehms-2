  ...
  <main class="container">
    ...
    <div class="content">
      ...
      <aside class="paperlike meta">
        ...
        <h1 <?php if ($isPrivileged) echo 'class="editable" contenteditable="true"' ?>><?php echo $mehm["Title"] ?></h1>
        <p <?php if ($isPrivileged && $mehm["Description"] != "") echo 'class="editable" contenteditable="true"' ?>><?php echo $mehm["Description"] ?></p>
