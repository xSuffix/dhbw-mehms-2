<?php $desc = isset($_GET["desc"]) ? $_GET["desc"] : false; ?>
...
<input type="checkbox" id="desc" name="desc" <?php echo ' value="' . ($desc ? 'false" checked' : 'true"'); ?> onchange="document.getElementById('query').submit()">